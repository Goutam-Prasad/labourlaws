exports.PtTax = function (stateCode, salary, gender) {
  ...
  } else if (stateCode == "kr") return (pttax = salary > 15000 ? 200 : "Nil");
  else if (stateCode == "ker") {
